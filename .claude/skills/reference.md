...
|------|---------|--------------------|
| **Översikt/hubb** | En produkt eller ett område introduceras; länkar till scenarioutkast | e.g. `overview.md`, `journey-optimizer-overview.md` |
| **Scenarioplan** | Enskilt fall: arkitektur, steg, skyddsräcken | e.g. `real-time-lookup.md`, `journey-optimizer-journeys.md` |
...
| Experience League (en) | `https://experienceleague.adobe.com/en/docs/` | Samma struktur som ovan med `/en/`. |
...
- **Beskrivande länktext**: `[Create schemas](https://experienceleague.adobe.com/...)` inte&quot;klicka här&quot;.
