---
title: Beteendescenario för webbpersonalisering
...
# Beteendescenario för webbpersonalisering
...
Anpassningsutkast för webb/mobiler kan implementeras med antingen Platform Web SDK eller Mobile SDK och Edge-nätverket, eller med antingen traditionella programspecifika SDK:er (till exempel AppMeasurement.js).

### Platform Web/Mobile SDK och Edge Network Approach
