...
description: Strömma insamlade data efter [!DNL Experience Platform] (AEP) SDK:er till flera sandlådor med hjälp av Event Forwarding
...
En plan för datainsamling för vidarebefordran i flera sandlådor visar hur data samlas in med Adobe [!DNL Experience Platform] SDK för webb och mobiler kan konfigureras för att samla in en enda händelse och vidarebefordra till flera [!DNL Experience Platform] (AEP) sandlådor. Det här utkast är ett särskilt användningsexempel som använder funktionen för händelsespridning i Adobe-taggar.
