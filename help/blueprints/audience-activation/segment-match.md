...
* Standardhash-identifierare som stöds är SHA256-hash-kodad e-post, hash-kodad telefon, ECID, Apple IDFA och GAID
...
| **Hantera målgruppsresurser** | Med den här behörigheten kan du skapa, redigera och publicera feeds (det datapaket som används för [!UICONTROL Segmentmatchning]) med aktiva partners (partners som administratörsanvändaren har anslutit till **Målgruppsanslutningar** åtkomst). |
