...
| --- | --- | --- | --- |
| [Purchase Journey Personalization](#vehicle-purchase-journey-personalization) | Personalisera fordonets inköpsresa från forskning till inköp med relevanta fordonsrekommendationer, finansieringsalternativ och information om återförsäljare. När potentiella köpare får skräddarsydd vägledning i varje steg går de snabbare och med större självförtroende genom funnel. | Förbättrade konverteringsgrader mellan leads och inköp och större säljmöjligheter | [Flerkanalsresor med beslut](/help/blueprints/use-case-patterns/campaign-management-orchestration/cross-channel-journey-with-decisioning.md) |
| [Påminnelser om tjänstavtalad tid](#service-appointment-reminders) | Skicka personliga påminnelser om tjänster baserat på bilkörning, servicehistorik och kundönskemål. Proaktiv utåtriktad verksamhet håller kvar fordon och ser till att kunderna återvänder till bilhandlaren i stället för att söka efter tredjepartsleverantörer. | Förbättrade besöksfrekvenser och ökade serviceintäkter | [Meddelanden som utlösts av händelser](/help/blueprints/use-case-patterns/campaign-management-orchestration/event-triggered-messaging.md) |
| [Värdekampanjer för handel](#trade-in-value-campaigns) | Erbjud proaktivt värdebedömningar till kunder som kan vara redo att uppgradera. Att nå ägare vid rätt tidpunkt i ägarcykeln snabbar upp vägen till ett nytt inköp av fordon. | Förbättrat samarbete och ökad försäljning av nya fordon | [Samlad resa i flera steg](/help/blueprints/use-case-patterns/campaign-management-orchestration/multi-step-orchestrated-journey.md) |
| [Rekommendationer för delar och tillbehör](#parts-and-accessories-recommendations) | Rekommendera relevanta delar, tillbehör och uppgraderingar baserat på fordonsmodell, ägartid och kundönskemål. Personaliserade eftermarknadsrekommendationer genererar inkrementella intäkter och hjälper ägare att få ut mer av sina fordon. | Förbättrade inköpspriser för reservdelar och tillbehör och ökade eftermarknadsintäkter | [Beteenderekommendation](/help/blueprints/use-case-patterns/personalization/behavioral-recommendation.md) |
| [Meddelanden om fordonsåterkallande](#vehicle-recall-notifications) | Skicka personaliserade meddelanden om återkallande med alternativ för schemaläggning av tjänst och säkerhetsinformation. Snabb, tydlig kommunikation om återkallande skyddar kundsäkerheten och visar varumärkets engagemang för ansvarsfull ägandesupport. | Förbättrade svarsfrekvenser för återkallande och bättre efterlevnad av säkerhetskrav | [Meddelanden som utlösts av händelser](/help/blueprints/use-case-patterns/campaign-management-orchestration/event-triggered-messaging.md) |
| [Nya startkampanjer för modeller](#new-model-launch-campaigns) | Rikta in er på kunder som kan vara intresserade av att lansera nya modeller baserat på deras aktuella fordon, preferenser och inköpshistorik. Fokuserad målgruppsanpassning maximerar starteffekten och skapar en tidig orderdrivkraft. | Förbättrat engagemang för lanseringskampanjer och ökat intresse för nya modeller | [Aktivera utgående batchmeddelande](/help/blueprints/use-case-patterns/campaign-management-orchestration/batch-outbound-message-activation.md) |
| [Erbjudanden om finansiering och försäkring](#financing-and-insurance-offers) | Presentera skräddarsydda finansierings- och försäkringserbjudanden baserat på kreditprofil, urval av fordon och tidslinje för inköp. Skräddarsydda finansiella produkter undanröjer köphinder och hjälper kunderna att känna sig säkra på sina villkor. | Förbättrade acceptansnivåer för finansiering och ökade intäkter per försäljning | [Offer Decisioning](/help/blueprints/use-case-patterns/personalization/offer-decisioning.md) |
| [Schemaläggning av testenhet](#test-drive-scheduling) | Möjliggör anpassad schemaläggning av testkörningar med återförsäljarrekommendationer och tillgång till fordon. Att göra det enkelt för intresserade köpare att komma bakom hjulet snabbar upp köpprocessen. | Förbättrad testkörningskomplettering och större säljkonvertering | [Meddelanden som utlösts av händelser](/help/blueprints/use-case-patterns/campaign-management-orchestration/event-triggered-messaging.md) |
| [Lojalitetsprogram för ägare](#owner-loyalty-programs) | Samordna kundlojalitetskommunikation över återförsäljare, OEM-digitala och anslutna bilkanaler, och tillämpa nivåbaserade regler för behörighet som styr vilka ägare som får exklusiva erbjudanden, tidig tillgång till fordon och partnerbelöningar. Skiljedomsalternativ förhindrar motstridiga kampanjer från återförsäljare och OEM-kanaler som når samma ägare samtidigt. | Förbättrat lojalitetsprogram och ökat antal upprepade köp | [Flerkanalsresor med beslut](/help/blueprints/use-case-patterns/campaign-management-orchestration/cross-channel-journey-with-decisioning.md) |
| [Garantier och utökade serviceplaner](#warranty-and-extended-service-plans) | Rekommendera garantier och utökade serviceplaner vid optimala tidpunkter baserat på fordonets ålder, körsträcka och köpmönster. Vältajmad utåtriktad teknik fångar upp intäkterna innan fabriksgarantierna upphör att gälla. | Förbättrad utökad garantianvändning och ökade serviceintäkter | [Samlad resa i flera steg](/help/blueprints/use-case-patterns/campaign-management-orchestration/multi-step-orchestrated-journey.md) |
| [Aktivering av kopplad bilfunktion](#connected-car-feature-activation) | Anpassa anslutna bilar efter behov utifrån fordonets kapacitet och tekniska preferenser. Att hjälpa ägare att upptäcka oanvända funktioner ökar nöjdheten och stärker den digitala relationen. | Ökad funktionsaktiveringshastighet och bättre kundupplevelse | [Samlad resa i flera steg](/help/blueprints/use-case-patterns/campaign-management-orchestration/multi-step-orchestrated-journey.md) |
| [Nätverkssamordning för återförsäljare](#dealer-network-coordination) | Möjliggör anpassade rekommendationer för återförsäljare baserat på kundens placering, preferenser och återförsäljarlager. Att knyta samman kunder med rätt återförsäljare förbättrar upplevelsen av köp och service. | Förbättrat handlarengagemang och bättre säljsamordning | [Known-Visitor Web/App Personalization](/help/blueprints/use-case-patterns/personalization/known-visitor-web-app-personalization.md) |
...
- Regler för nivåbaserad behörighet måste konfigureras i [!DNL Journey Optimizer]-beslutet för att styra vilka ägare som är kvalificerade för exklusiva erbjudanden, tidig åtkomst till nya utsagor och inlösen av partnerbelöningar, så att endast berättigade medlemmar får varje förmånskategori.
- Skiljedomslogiken måste utvärdera väntande meddelanden från både återförsäljare och OEM-kanaler innan ett meddelande skickas, vilket förhindrar lågprioriterade eller motstridiga kampanjer för att förhindra att samma ägare får motstridiga erbjudanden samtidigt.
- Samordning mellan olika kanaler måste omfatta CRM-system för återförsäljare, digitala OEM-lokaler, kanaler för meddelanden om anslutna bilar och kontaktpunkter för service så att lojalitetsinteraktionerna blir enhetliga oavsett var ägaren interagerar.
