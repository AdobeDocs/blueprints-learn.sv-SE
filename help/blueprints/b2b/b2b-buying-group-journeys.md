...
* Om aktivering krävs via Marketo Engage-kanaler på kontoresan eller om CRM Sync används för att berika kontot, är de [Marketo Engage-relaterade garantierna](https://helpx.adobe.com/legal/product-descriptions/adobe-marketo-engage---product-description.html#performance-guardrails) relevanta.
