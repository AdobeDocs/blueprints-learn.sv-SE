---
title: Översikt över Marketo Engage- och Workfront-integreringsplanen
description: Översikt - Integrering av Marketo Engage och Workfront - översikt
...
# Översikt över Marketo Engage- och Workfront-integreringsplanen {#overview}

## Få snabbare time-to-market med Marketo Engage och Workfront {#achieve-faster-time-to-market-with-marketo-engage-and-workfront}
...
Genom att integrera aktiveringssystemet för flerkanalsmarknadsföring (Marketo Engage) med marknadsföringsplaneringen och inspelningssystemet (Workfront) kan ni öka kampanjhastigheten och ge intressenter bättre synlighet.
...
* Stödja marknadsföringsteamen genom att automatisera framtagningen av kampanjer i Marketo Engage via inmatningsbegäran i Workfront
...
>[!NOTE]
>
>I exemplet ovan hanterar och planerar Workfront arbetsinsatser under Marketo Engage-programmets hela livscykel. Workfront flexibilitet kan dock även omfatta hantering av alla marknadsföringsteamets satsningar. Detta omfattar kontobaserad marknadsföring, innehållsleveranskedjor för marknadsföring, myndighetshantering, hantering av digitala och sociala kampanjer samt säljaktiveringsprogram.
...
<table> 
  ...
  <tr> 
   <td>Portfolio</td>
   <td>Du kan använda portföljer och program i Workfront för att ordna projekt. Genom att organisera projekt kan du jämföra liknande projekt och fastställa var resurser ska användas bäst.<br /><br />
   (t.ex. skapas en Portfolio för en affärsenhet inom ett företag som fokuserar på att sälja tjänster och/eller produkter.)</td>
  </tr>
  <tr>
   <td>Program</td>
   <td>Du kan använda Workfront-program för att ordna projekt. Genom att organisera projekt kan du jämföra liknande projekt och fastställa var resurser ska användas bäst.<br /><br />
  ...
  <tr>
   <td>Projekt</td>
   <td>Workfront Projects är en samling arbetsobjekt som måste slutföras för att ett specifikt mål, slutprodukt, produkt osv. <br /><br /> ska kunna uppnås
  ...
  <tr>
   <td>Problem</td>
   <td>Det finns oplanerade arbetsuppgifter i Workfront. Det kan vara problem som uppstår under ett projekt, eller så kan det vara begäranden som skickas via en begärandekö.<br /><br />
   (t.ex. ett fel uppstår eftersom e-postbanderollbilden har fel dimensioner.)</td>
  </tr>
  <tr>
   <td>Dokument</td>
   <td>Dokument kan vara traditionella dokument som Word-dokument eller presentationer. De kan också vara bildfiler. Workfront tillåter granskning av resurser genom kommentarer och anteckningar i dokument och bilder, vilket möjliggör samarbete mellan team.<br /><br />
...
När ni börjar kartlägga er kampanjutvecklingsprocess i Workfront kan ni också tänka på vilka uppgifter som ska utföras i Marketo Engage och hur ni kan samla in information i Workfront, vilket ökar enhetligheten, effektiviteten och exaktheten i kampanjutvecklingen i supply chain.
...
Nu när ni har en grundläggande förståelse för hur Workfront och Marketo Engage kan öka effektiviteten i er kampanjutveckling supply chain kan ni läsa följande dokument och resurser om hur ni kan automatisera arbetsflöden och processer mellan Marketo Engage och Workfront med Workfront Fusion.

### Komma igång med Workfront Fusion-, Workfront- och Marketo Engage-integrering {#getting-started-with-workfront-fusion}
...
### Hantera namn på Marketo Engage-kampanjer och deras associerade URL:er {#managing-marketo-engage-campaign-names}

Att standardisera era namngivningskonventionerna för kampanjer och URL:er är en viktig grund för en korrekt programhantering i Marketo Engage och bidrar till en mer konsekvent process under kampanjens utvecklingslivscykel. Om du letar efter verktyg som kan hjälpa dig med detta rekommenderar vi att du checkar ut kostnadsfria verktyg med öppen källkod från [Adobe Success Services](https://main—marketo-campaign-tools—dr-adobe.hlx.live/){target="_blank"} som gör att du kan skapa ett konsekvent sätt att skapa och hantera Marketo Engage-kampanjer och deras associerade URL:er.

### Resurser {#resources}

* [Workfront Fusion for Marketo Engage](https://experienceleague.adobe.com/docs/workfront/using/adobe-workfront-fusion/fusion-apps-and-modules/marketo-modules.html?lang=sv-SE){target="_blank"}

* [Workfront Fusion for Workfront](https://experienceleague.adobe.com/docs/workfront/using/adobe-workfront-fusion/fusion-apps-and-modules/workfront-modules.html?lang=sv-SE){target="_blank"}
