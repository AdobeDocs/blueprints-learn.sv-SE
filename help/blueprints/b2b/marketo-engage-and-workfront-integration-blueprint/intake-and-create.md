...
Med Workfront och Marketo Engage kan du via en system-till-system-anslutning skapa Marketo Engage-program med hjälp av information från ett [Workfront-formulär](https://experienceleague.adobe.com/docs/workfront/using/administration-and-setup/customize/custom-forms/create-or-edit-a-custom-form.html){target="_blank"} och sedan fylla i viktiga variabler som ämnesrader, e-postkopia, bilder, datum, tider, händelseinformation med mera.
