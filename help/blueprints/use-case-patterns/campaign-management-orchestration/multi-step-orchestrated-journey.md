...
>[!NOTE]
>Om din resa kräver ett dynamiskt urval av det optimala erbjudandet, innehållet eller kanalen vid enskilda beslutspunkter, se [Flerkanalsresan med beslut](cross-channel-journey-with-decisioning.md). Det mönstret utökar det här med AJO Decisioning-integrering.
