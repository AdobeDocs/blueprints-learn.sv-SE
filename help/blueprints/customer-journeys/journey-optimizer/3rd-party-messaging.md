...
1. [Aktivera scheman och datauppsättningar för profilen](https://experienceleague.adobe.com/en/docs/platform-learn/tutorials/profiles/bring-data-into-the-real-time-customer-profile).
...
* [Dokumentation för Experience Platform Mobile SDK](https://experienceleague.adobe.com/docs/mobile.html)
